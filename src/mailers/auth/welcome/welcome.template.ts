...
export function getWelcomeTemplate(data: WelcomeTemplateData): string {
  const { firstName, setupLink, logoUrl } = data;
...
<head>
  ...
  <title>Welcome to Seeman Auto</title>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #374151;">
                Your account has been created. Before you can log in, you need to set your password by clicking the button below.
              </p>
              ...
              <div style="padding: 16px; background-color: #eff6ff; border-radius: 6px; border-left: 4px solid #4f46e5;">
          ...
          <tr>
            <td style="padding: 24px 40px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; border-radius: 0 0 8px 8px;">
              <p style="margin: 0; font-size: 12px; line-height: 1.5; color: #6b7280; text-align: center;">
                &copy; ${new Date().getFullYear()} Seeman Auto & Agro Ind. Ltd. All rights reserved.
              </p>
